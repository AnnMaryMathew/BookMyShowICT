...
public class TestCase_14 extends BasePage {

    public TestCase_14(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    //TestCase 14 : Validate Sorted Product(Success)
    public void sortValidate() throws IOException {
        try {
            ...
            takeScreenshot("ValidateSort");


        } catch (Exception e) {
            Reports.extentTest.log(Status.FAIL, e);
            takeScreenshot("ValidateSortFailed");
